...
//loading is to diabled submit button
  const {
    register,
    handleSubmit,
    formState: { errors },
  } = useForm({ resolver: zodResolver(signupSchema) });   // to use zod(i.e to check the variable syntax email,firstName) with reactForm need to install  zodResolver
  ...
  const onSubmit = (data) => { //putting data as argument is done by the reactform , 
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-control">
              ...
              <input
                ...
                {...register('firstName')}  //format to map variable(firstName) with reactForm objects register 
              />
              {errors.firstName && (
